        ...
        $(document).ready(function(){
            $("#search_btn").click(function(){
                if($("#q").val() == ''){
                    ...
                    var act = '/bbs_board/lists/ci_board/q/'+$("#q").val()+'/page/1';
                }
            });
        });
...
?>
        ...
        <div><p><a href="/bbs_board/write/<?php echo $this->uri->segment(3);?>/page/<?php echo $this->uri->segment(5);?>" class="btn btn-success">쓰기</a></p></div>
        <div>
<?php
            echo form_open('/bbs_board/lists/ci_board', array('id'=>'bd_search', 'class'=>'well form-search'));
?>
